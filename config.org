...
Really useful little minor mode that makes sure your git repos are
always up to date.
#+BEGIN_SRC emacs-lisp
  (use-package projectile-git-autofetch
    ...
    (setq projectile-git-autofetch-projects 'all
	  projectile-git-autofetch-interval 1800
	  projectile-git-autofetch-initial-delay 30))
#+END_SRC
* Yasnippet
