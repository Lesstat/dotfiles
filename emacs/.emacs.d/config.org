...
entries, opening pdfs of references and taking notes. I throw in two
small functions of my own to easily open either the central notes file
or the central bibtex file. I also configure reftex to use the org-ref
...
#+END_SRC
** git-gutter-fringe
Git gutter shows which lines have changed (according to a vc like git)
in the gutter. I have been inspired to look into it by a video on
