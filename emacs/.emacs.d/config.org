...
*** Todo Stuff
#+BEGIN_SRC emacs-lisp
  (setq fb/inbox-file "~/brain/org/inbox.org")
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (file fb/inbox-file)
           "* TODO %?
  :PROPERTIES:
  :CREATION_DOC: %a
  :CREATION_DATE: %U
  :END:
  ")
          ("n" "Note" entry (file fb/inbox-file)
           "* %?
  :PROPERTIES:
  :CREATION_DOC: %a
  :CREATION_DATE: %U
  ...
  (setq org-archive-location "~/brain/archive/archive.org::datetree/* Finished")
#+END_SRC
