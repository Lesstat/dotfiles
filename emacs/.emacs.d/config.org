  ...
  (use-package heaven-and-hell
    ...
    (setq heaven-and-hell-themes
          '((light . spacemacs-light)
            (dark . spacemacs-dark))) 
    (defvar fb/heaven-and-hell-loaded nil)
    (if (daemonp)
        (add-hook 'after-make-frame-functions
                  (lambda (frame)
                    (select-frame frame)
                    (unless fb/heaven-and-hell-loaded
                      (setq fb/heaven-and-hell-loaded 
                            (load-theme (cdar heaven-and-hell-themes) t)))))))
#+END_SRC
** Evil-mode
...
#+BEGIN_SRC emacs-lisp
  (setq org-todo-keyword-faces
        (quote
         (("PROJECT" :foreground "blue" :background "white")
          ("DEFERRED" :foreground "dark blue" :background "white")
          ("IDEA" :foreground "dark green" :background "white")
          ("TODO" :foreground "dark orange" :weight bold  :background "white")
          ("WAIT" :foreground "red"  :background "white"))))
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    ;; integrate yasnippet with company/ insert snippets with open completion
